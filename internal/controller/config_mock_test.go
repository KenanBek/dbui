...
//
//	mockgen -source=dbui.go -destination=./controller/config_mock_test.go -package=controller -mock_names=AppConfig=MockAppConfig
//
...
func (mr *MockDataSourceMockRecorder) DescribeTable(schema, table any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataSourceMockRecorder) ListTables(schema any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataSourceMockRecorder) PreviewTable(schema, table any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataSourceMockRecorder) Query(schema, query any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataControllerMockRecorder) Switch(alias any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// MockCommittable is a mock of Committable interface.
type MockCommittable struct {
	ctrl     *gomock.Controller
	recorder *MockCommittableMockRecorder
	isgomock struct{}
}

// MockCommittableMockRecorder is the mock recorder for MockCommittable.
type MockCommittableMockRecorder struct {
	mock *MockCommittable
}

// NewMockCommittable creates a new mock instance.
func NewMockCommittable(ctrl *gomock.Controller) *MockCommittable {
	mock := &MockCommittable{ctrl: ctrl}
	mock.recorder = &MockCommittableMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCommittable) EXPECT() *MockCommittableMockRecorder {
	return m.recorder
}

// Commit mocks base method.
func (m *MockCommittable) Commit() error {
	m.ctrl.T.Helper()
...
func (mr *MockCommittableMockRecorder) Commit() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Commit", reflect.TypeOf((*MockCommittable)(nil).Commit))
}
